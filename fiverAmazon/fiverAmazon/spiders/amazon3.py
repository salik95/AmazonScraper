...
class Amazon3Spider(scrapy.Spider):

	name = 'amazon3'
	start_urls = ['https://www.amazon.co.uk/s/ref=sr_nr_p_36_5?rnid=389022011&rh=n%3A266239%2Cp_n_binding_browse-bin%3A492563011&qid=1540500518&bbn=266239&low-price=2000&high-price=3000']
	...
	def parse_author(self, response):
		...
		if locale.atoi(bsr) <= 3000000:
			...
			print('=================================================================')
			if len(used_offer) > 1:
				if locale.atof(price) >= 2000.00 and locale.atof(price) <= 3000.00:
	...
	def spider_closed(self, spider):
		print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
		outfile = open('2000_3000_under_3_million.csv', 'w')
